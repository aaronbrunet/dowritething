...
export const Select = ( props ) => {    
    ...
    return (
        <>
        <select className="inline-flex mr-4 flex-row justify-between w-48 px-2 py-2 text-gray-700 bg-white border-2 border-white rounded-md shadow focus:border-spring-wood-600" name={name} defaultValue={selected} value={selected} onChange={(e)=>handleOnChange(e.target.value)}>            
